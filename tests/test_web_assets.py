...
class WebAssetSmokeTests(unittest.TestCase):
    ...
    def test_reviewer_loads_versioned_anki_assets(self):
        ...
        self.assertIn('src="reviewer_state.js?v=8"', html)
        self.assertIn('src="reviewer_app.js?v=9"', html)
        ...
        self.assertIn("updateSyncUi", app)
        self.assertIn("Waiting...", app)
        self.assertIn('class="btn sync-btn sync-confirmed"', html)
